        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ flexDirection: 'row', display: 'flex', marginTop: 35 }}>
                ...
                <View>
                    ...
                    <View style={{ backgroundColor: 'rgba(87, 152, 249, 0.11)', width: 294, height: 81, borderRadius: 9, borderColor: '#01E17B', borderWidth: 1, marginTop: 30, flexDirection: 'row', display: 'flex', padding: 10 }}>
                    ...
                    <View style={{ backgroundColor: 'rgba(87, 152, 249, 0.11)', width: 294, height: 81, borderRadius: 9, borderColor: '#01E17B', borderWidth: 1, marginTop: 30, flexDirection: 'row', display: 'flex', padding: 10 }}>
                        ...
                        <View style={{ marginLeft: 5 }}>
                            ...
                            <View style={{ marginTop: 10, display: 'flex', flexDirection: 'row' }}>
                                <Image style={{ width: 27, height: 27 }} source={require('../../assets/images/jumboboxselected.png')} />
                                <Text style={{ color: '#7F7E7E', marginTop: 5, marginLeft: 5 }}>Jumbo Box is selected</Text>
                            </View>
                        </View>
                    </View>
                    <View style={{ backgroundColor: 'rgba(87, 152, 249, 0.11)', width: 294, height: 81, borderRadius: 9, borderColor: '#6073EE', borderWidth: 1, marginTop: 30, flexDirection: 'row', display: 'flex', padding: 10 }}>
            ...
            <NextButton onPress={() => navigation.navigate('ChooseAddons')} />
            <BackButton onPress={() => navigation.navigate('ChooseTruck')} />
        </SafeAreaView>
    )
}
