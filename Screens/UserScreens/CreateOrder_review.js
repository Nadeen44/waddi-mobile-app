        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ flexDirection: 'row', display: 'flex', marginTop: 35 }}>
                ...
                <View>
                    ...
                    <View style={{ backgroundColor: 'rgba(87, 152, 249, 0.11)', width: 294, height: 81, borderRadius: 9, borderColor: '#01E17B', borderWidth: 1, marginTop: 20, flexDirection: 'row', display: 'flex', padding: 10 }}>
...
<View style={{ marginLeft: 5 }}>
                    ...
                    <View style={{ backgroundColor: 'rgba(87, 152, 249, 0.11)', width: 294, height: 81, borderRadius: 9, borderColor: '#01E17B', borderWidth: 1, marginTop: 30, flexDirection: 'row', display: 'flex', padding: 10 }}>
                        ...
                        <Text style={{ fontSize: 17, fontWeight: 'bold', color: '#263238' }}>Add-Ons<Text style={{ color: '#415BF6' }}>*</Text></Text>
                            <View style={{ marginTop: 10 }}>
                                <Text style={{ color: '#7F7E7E', marginTop: -1, marginLeft: 5 }}>No Add-Ons is selected</Text>
                            </View>
                        </View>
                    </View>
                </View>
            ...
            <NextButton onPress={() => navigation.navigate('ReviewOrder')} />
            <BackButton onPress={() => navigation.navigate('ChooseAddons')} />
