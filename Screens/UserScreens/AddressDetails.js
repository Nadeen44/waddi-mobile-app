        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ flexDirection: 'row', display: 'flex', marginTop: 35 }}>
                ...
                <View>
                    ...
                    <View style={{ backgroundColor: 'rgba(87, 152, 249, 0.11)', width: 294, height: 81, borderRadius: 9, borderColor: '#D9D9D9', borderWidth: 1, marginTop: 20, flexDirection: 'row', display: 'flex', padding: 10 }}>
...
<View style={{ marginLeft: 5 }}>
            ...
            <NextButton onPress={() => navigation.navigate('ChooseCommedity')} />
            <BackButton onPress={() => navigation.navigate('AddressMap')} />
