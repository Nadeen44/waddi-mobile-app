...
const onNextPress = () => {
  navigation.navigate('CreateOrder_trucks', { selectedCommodity });
};

const CreateOrder_trucks = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <NextButton  onPress={() => navigation.navigate('ChooseTruck')} />
      <BackButton onPress={() => navigation.navigate('Commedity')} />
    </SafeAreaView>
  )
}

export default CreateOrder_trucks
